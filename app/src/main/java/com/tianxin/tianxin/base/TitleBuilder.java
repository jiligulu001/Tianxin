package com.tianxin.tianxin.base;
...
public class TitleBuilder implements View.OnClickListener {
    ...
    protected TextView             mTitleLeftText;//title左边文本显示
    ...
    protected View initBar(int layoutId) {
        ...
        mTitleMiddleRelativeLayout = (RelativeLayout) mTitleView.findViewById(R.id.middle_relative_layout);
        mTitleLeftImageView = (ImageView) mTitleView.findViewById(R.id.left_icon_title);
        mTitleLeftText = (TextView) mTitleView.findViewById(R.id.left_text);
    ...
    public TitleBuilder setLeftText(String text) {
        // mTitleLeftText.setVisibility(TextUtils.isEmpty(text) ? View.GONE : View.VISIBLE);
    ...
    public TitleBuilder setLeftTextColor(int colorId) {
        mTitleLeftText.setTextColor(colorId);
        return this;
    }
    ...
    public TitleBuilder setLeftButtonEnabled(boolean enable) {
        mTitleLeftText.setEnabled(enable);
        return this;
    }
    ...
    public void onClick(View view) {
        ...
        if (view == mTitleLeftImageView || view == mTitleLeftText || view == mTitleLeftRelativeLayout) {
