...
/**
 * Created by PC大佬 on 2017/4/7.
 */
public abstract class TitleBarActivity extends AppCompatActivity implements TitleBuilder.TitleBuilderListener {
    ...
    public void setContentView(int id) {
        ...
        this.initTitleBar(mTitleBuilder);
    ...
    public abstract void initTitleBar(TitleBuilder mTitleBuilder);
                    ...
                    public boolean onPreDraw() {
                        ...
                        if (!isFirst) {
                            if (height + 1 > getScreenHeight()) {
                                ...
                                ScrollView scrollView = new ScrollView(TitleBarActivity.this);
