...
public class JsonConvert<T> implements Converter<T> {
    ...
    public T convertSuccess(Response response) throws Exception {
        ...
        //com.lzy.demo.callback.JsonDialogCallback<com.lzy.demo.model.OKgoResponse<com.lzy.demo.model.ServerModel>> 得到类的泛型，包括了泛型参数
        Type genType = getClass().getGenericSuperclass();
        //从上述的类中取出真实的泛型参数，有些类可能有多个泛型，所以是数值
        Type[] params = ((ParameterizedType) genType).getActualTypeArguments();
        //我们的示例代码中，只有一个泛型，所以取出第一个，得到如下结果
        //com.lzy.demo.model.OKgoResponse<com.lzy.demo.model.ServerModel>
        Type type = params[0];
        ...
        //class com.lzy.demo.model.OKgoResponse
        ...
        if (typeArgument == Void.class) {
            //无数据类型,表示没有data数据的情况（以  new JsonDialogCallback<OKgoResponse<Void>>(this)  以这种形式传递的泛型)
