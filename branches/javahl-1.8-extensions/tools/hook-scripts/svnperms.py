...
# $HeadURL: http://svn.apache.org/repos/asf/subversion/branches/javahl-1.8-extensions/tools/hook-scripts/svnperms.py $
# $LastChangedDate: 2011-07-13 02:37:44 +0800 (Wed, 13 Jul 2011) $
# $LastChangedBy: blair $
