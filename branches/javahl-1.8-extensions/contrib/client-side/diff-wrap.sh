...
# ====================================================================
#
# $HeadURL: http://svn.apache.org/repos/asf/subversion/branches/javahl-1.8-extensions/contrib/client-side/diff-wrap.sh $
# $LastChangedDate: 2008-03-11 02:07:08 +0800 (Tue, 11 Mar 2008) $
# $LastChangedBy: dlr $
