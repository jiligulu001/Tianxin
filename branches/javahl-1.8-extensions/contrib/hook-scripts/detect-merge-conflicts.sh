...
# error message.
#
# $HeadURL: http://svn.apache.org/repos/asf/subversion/branches/javahl-1.8-extensions/contrib/hook-scripts/detect-merge-conflicts.sh $
# $LastChangedDate: 2013-04-11 10:38:26 +0800 (Thu, 11 Apr 2013) $
