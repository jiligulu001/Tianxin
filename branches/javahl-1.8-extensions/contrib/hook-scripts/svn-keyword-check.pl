...
#
# $HeadURL: http://svn.apache.org/repos/asf/subversion/branches/javahl-1.8-extensions/contrib/hook-scripts/svn-keyword-check.pl $
# $LastChangedRevision: 1491757 $
# $LastChangedDate: 2013-06-11 19:49:27 +0800 (Tue, 11 Jun 2013) $
# $LastChangedBy: brane $
